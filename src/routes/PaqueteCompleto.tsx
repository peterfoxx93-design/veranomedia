    ...
    <div className="pt-20">
      ...
      <section className="relative bg-[#1C1C1E] text-white overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/3 left-1/3 w-[500px] h-[500px] bg-[#5170FF]/15 rounded-full blur-3xl" />
        ...
        <div className="container-vm relative z-10 py-28 md:py-36 text-center">
          <motion.span initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
            className="text-sm font-semibold text-[#5170FF] uppercase tracking-widest block mb-4">
            🚀 Verano Media Pro
          </motion.span>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
            ...
            <span className="text-5xl md:text-6xl font-extrabold text-[#5170FF]">$28,000 RD$</span>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
            <a href="https://wa.me/18093586497" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#5170FF] text-white px-10 py-4 rounded-vm-md text-lg font-semibold hover:bg-[#5170FF]/90 transition-all duration-300 hover:shadow-vm-lg hover:-translate-y-1">
              Quiero este paquete
            </a>
          </motion.div>
        </div>
        ...
        <div className="container-vm">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <motion.span initial={{ opacity: 0, y: 10 }} animate={ref ? { opacity: 1, y: 0 } : {}}
              className="text-sm font-semibold text-[#5170FF] uppercase tracking-widest block mb-2">
              Incluye
            </motion.span>
