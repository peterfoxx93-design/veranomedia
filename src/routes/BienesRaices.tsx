    ...
    <div className="overflow-hidden">
        ...
        <div className="container-vm relative z-10 py-32 md:py-40">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
            ...
            <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl text-white leading-[1.05] tracking-tight mb-6">
              Bienes Raíces<br />
              <span className="text-[#5170FF]">Costa Norte</span>
            </h1>
        ...
        <div className="container-vm">
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto mb-12">
              <span className="text-xs font-semibold text-[#5170FF] uppercase tracking-[0.2em]">Propiedades Destacadas</span>
      ...
      <section className="section-vm-alt">
        <div className="container-vm">
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto mb-12">
              <span className="text-xs font-semibold text-[#5170FF] uppercase tracking-[0.2em]">Nuestros Servicios</span>
        ...
        <div className="container-vm">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeIn direction="left">
              <div>
                <span className="text-xs font-semibold text-[#5170FF] uppercase tracking-[0.2em]">Sobre Nosotros</span>
                ...
                <div className="flex flex-wrap gap-6">
                  {[
                    ...
                    <div key={i}>
                      <div className="text-2xl font-bold text-[#5170FF]">{s.value}</div>
      ...
      <section className="section-vm-alt">
        <div className="container-vm">
          <FadeIn>
            <div className="text-center max-w-2xl mx-auto mb-12">
              <span className="text-xs font-semibold text-[#5170FF] uppercase tracking-[0.2em]">Testimonios</span>
      ...
      <section className="relative bg-[#0F1A2E] text-white py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 right-1/4 w-[500px] h-[500px] bg-[#5170FF]/10 rounded-full blur-3xl" />
        </div>
