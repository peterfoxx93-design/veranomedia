...
const footerLinks = {
  ...
  social: [
    {
      label: 'Instagram',
      href: 'https://www.instagram.com/veranomedialab',
      icon: (
    ...
    {
      label: 'LinkedIn',
      href: 'https://www.linkedin.com/in/peter-fx-478a8a40a',
      icon: (
        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      label: 'Facebook',
      href: 'https://www.facebook.com/profile.php?id=61589621044768',
      icon: (
        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-white/50">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 hover:text-[#34C759] transition-colors duration-200"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                href="https://mail.google.com/mail/?view=cm&fs=1&to=hola@veranomedia.click"
