...
OUT = os.path.expanduser("~/veranomedia/redes/carrusel-legal")
W, H = 1080, 1350
...
badge = "BUFETES JURÍDICOS · VERANO MEDIA"
...
y += 40
y = draw_block(d, "LOS CLIENTES BUSCAN", f_h1, WHITE, W//2, y, 900, 6)
y = draw_block(d, "A SU ABOGADO", f_h1, WHITE, W//2, y, 900, 6)
y = draw_block(d, "EN GOOGLE", f_h1, BLUE, W//2, y, 900, 6)
y += 30
draw_block(d, "Si no apareces en la primera página, el cliente no te encuentra.", f_sub, GREY, W//2, y, 860, 10)
...
y += 40
y = draw_block(d, "75% de las búsquedas", f_h, WHITE, W//2, y, 860, 8)
y = draw_block(d, "no pasan de la primera página", f_h, WHITE, W//2, y, 860, 8)
y += 40
draw_block(d, "Si tu web no está ahí, el cliente ni te conoce.", f_b, GREY, W//2, y, 860, 10)
draw_block(d, "Y el que aparece primero se lleva el cliente.", f_b, GREY, W//2, y+70, 860, 10)
...
y += 40
y = draw_block(d, "Sin web profesional,", f_h, WHITE, W//2, y, 860, 8)
y = draw_block(d, "transmite desconfianza", f_h, WHITE, W//2, y, 860, 8)
y += 40
draw_block(d, "Un bufete sin web parece un consultorio de la esquina.", f_b, GREY, W//2, y, 860, 10)
draw_block(d, "La imagen vende tanto como el argumento.", f_b, GREY, W//2, y+70, 860, 10)
...
y += 40
y = draw_block(d, "Sin respuesta rápida,", f_h, WHITE, W//2, y, 860, 8)
y = draw_block(d, "el cliente va a otro bufete", f_h, WHITE, W//2, y, 860, 8)
y += 40
draw_block(d, "Un formulario sin respuesta es un cliente perdido.", f_b, GREY, W//2, y, 860, 10)
draw_block(d, "Un chatbot + WhatsApp automático lo captura por ti.", f_b, GREY, W//2, y+70, 860, 10)
...
y = 160
y = draw_block(d, "Tu web es tu", f_h, WHITE, W//2, y, 920, 8)
y = draw_block(d, "mejor asociado", f_h, GREEN, W//2, y, 920, 8)
y += 70
draw_block(d, "Web profesional + SEO local + WhatsApp automático.", f_b, GREY, W//2, y, 860, 10)
